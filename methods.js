...
// getUserById(users, 5); // должен вывести в консоль объект юзера с id === 2
...
function deleteUser(array, id) {
    const newArr = array.filter(user => user.id !== id)
    return newArr;
}
...
// console.log(changePhone(users, 10, '3805'));